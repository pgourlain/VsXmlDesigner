...
namespace Genius.VS2013DesignerAndEditor
{
    ...
    //     - An empty xml file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyXmlFile.xml. Note this file name appears in Editor.vsdir
    ...
    //          - "MyXmlFile" - This is the base file name. New files will initially
    //             be named as MyXmlFile1.xml, MyXmlFile2.xml... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyXmlFile.xml|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyXmlFile.xml - our empty xml file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".xml";
        ...
        #region Fields
        private VS2013DesignerAndEditorPackage myPackage;
        ...
        public EditorPane(VS2013DesignerAndEditorPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        private void PrivateInit(VS2013DesignerAndEditorPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidVS2013DesignerAndEditorCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidVS2013DesignerAndEditorCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidVS2013DesignerAndEditorEditorFactory;
            return VSConstants.S_OK;
        }
